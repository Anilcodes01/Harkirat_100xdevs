...
function Sidebar() {
  return (
    <div className=''>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-blue-500">
          <a href="https://flowbite.com/" className="flex items-center ps-2.5 mb-10">
            <img
              src="https://img.freepik.com/premium-vector/onion-logo-vector-red-onion-icon-illustration-simple-onion-symbol_487414-1431.jpg"
              className="h-6 me-3 sm:h-11 rounded"
              alt="Flowbite Logo"
            />
          ...
          <div className='flex flex-col'>
           <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">
            ...
            <button className='mr-5 text-gray-600 underline'>Visit Store</button>
            
           </div>
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white ml-11 font-bold">
  <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          ...
          <ul className="space-y-2 font-medium mt-3 flex-row  ">
            <li className='ml-1 '>
            <div className='flex w-full h-10 rounded pl-2 items-center gap-3 hover:bg-slate-600'>
